...
const Diferenciais = () => {
  ...
  return (
    <div className='flex flex-col w-full  py-[5rem] justify-center items-center text-white
    bg-gradient-to-tr from-[#143c40] to-[#06292d]'>

      <div className='flex flex-col w-full items-center justify-center'>

        <div className='flex lg:flex-row flex-col w-[90%]'>
          <p className='lg:text-4xl text-xl lg:w-1/2 w-full'>
        ...
        <div className='flex flex-row items-center justify-start lg:w-full w-screen h-[30rem] gap-10 lg:mt-20 mt-10 carousel carousel-end'>
          {data.map((info, index) => 
